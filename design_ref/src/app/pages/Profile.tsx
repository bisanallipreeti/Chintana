...
export function Profile() {
  ...
  const cities = draft.countryIso && draft.stateCode ? getCitiesForState(draft.countryIso, draft.stateCode) : [];
          ...
          <div className="relative bg-gradient-to-r from-blue-600 to-violet-600 px-6 py-6">
            <div className="flex flex-col sm:flex-row items-center gap-4">
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <p className="text-blue-100 mb-1">{draft.designation || "Profile details not added yet"}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            />
              ...
              <div>
                ...
                <div className="grid grid-cols-[84px_1fr] gap-2 items-center">
                  <CountryCodePicker
                ...
                <input
                  ...
                  disabled={!isEditing}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all disabled:bg-gray-50 disabled:text-gray-600"
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={!isEditing}
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all disabled:bg-gray-50 disabled:text-gray-600"
                />
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <SearchableTextPicker
                ...
                disabled={!isEditing || !draft.stateCode}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2 p-4 bg-green-50 border border-green-200 rounded-xl">
              <div className="flex items-center justify-between gap-4">
                <div>
                  <p className="text-sm text-green-700 mb-1">Total Annual Income</p>
                  <p className="text-2xl font-bold text-green-900">
                    {symbolFormatter.format(Number.isFinite(totalAnnualIncome) ? totalAnnualIncome : 0)}
                  </p>
                </div>
                <div className="text-right">
                  <p className="text-sm text-green-700 mb-1">Monthly Average</p>
          ...
          <div className="space-y-4">
            {draft.emergencyContacts.length === 0 ? (
              <div className="p-6 border border-dashed border-gray-300 rounded-xl bg-gray-50 text-center">
                {isEditing ? (
                  ...
                  <p className="text-sm text-gray-500">Click Edit Profile to add emergency contacts.</p>
                )}
              </div>
            ) : (
            ...
            {pendingEmergencyContact && (
              <div className="p-4 border border-blue-200 rounded-xl bg-blue-50/50">
                <div className="flex items-start justify-between mb-3">
                  <h3 className="font-medium text-gray-900">New Emergency Contact</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <TextField
                    label="Contact Name"
    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          disabled={disabled}
          className={`w-full ${icon ? "pl-10" : "pl-4"} pr-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all disabled:bg-gray-50 disabled:text-gray-600 ${
  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="w-full h-full px-3 py-3 border border-gray-300 rounded-lg text-left bg-white disabled:bg-gray-50 disabled:text-gray-600"
      >
        <span className="text-base mr-1">{selected.flag}</span>
        <span className="text-xs font-semibold">+{selected.phonecode}</span>
      </button>
      {open && !disabled && (
        <div className="absolute z-20 mt-2 w-[30rem] max-w-[calc(100vw-2rem)] bg-white border border-gray-200 rounded-2xl shadow-2xl overflow-hidden">
          <div className="sticky top-0 z-10 p-3 border-b border-gray-100 bg-white">
            <div className="relative">
          ...
          <div className="max-h-96 overflow-y-auto overscroll-contain">
            {filtered.map((country) => (
              <button
                ...
                className="w-full px-5 py-4 text-left hover:bg-gray-50 flex items-center justify-between gap-6"
              >
                <span className="flex items-center gap-3 min-w-0 flex-1">
                  <span className="text-lg">{country.flag}</span>
                  <span className="text-sm text-gray-800 whitespace-normal break-words leading-6">
                    {country.name}
                  </span>
                </span>
                <span className="text-sm font-medium text-gray-500 shrink-0 whitespace-nowrap min-w-[7rem] text-right">
                  +{country.phonecode}
                </span>
              </button>
            ))}
  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        disabled={disabled}
        onClick={() => setOpen((previous) => !previous)}
        className="w-full px-4 py-3 border border-gray-300 rounded-lg text-left bg-white disabled:bg-gray-50 disabled:text-gray-600"
      >
        {selected?.label || placeholder}
      </button>
      {open && !disabled && (
        <div className="absolute z-20 mt-2 w-[34rem] max-w-[calc(100vw-2rem)] bg-white border border-gray-200 rounded-2xl shadow-2xl overflow-hidden">
          <div className="sticky top-0 z-10 p-3 border-b border-gray-100 bg-white">
            <div className="relative">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
              <input
          ...
          <div className="max-h-96 overflow-y-auto overscroll-contain">
            {filtered.map((option) => (
              <button
                ...
                className="w-full px-4 py-4 text-left hover:bg-gray-50 text-sm text-gray-800 whitespace-normal"
              >
                {option.label}
              </button>
            ))}
